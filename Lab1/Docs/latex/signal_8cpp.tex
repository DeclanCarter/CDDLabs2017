...
Two threads running with Semaphores that signal one to proceed while the other is signalled to wait for the first one to finish \index{signal.\+cpp@{signal.\+cpp}!task\+Two@{task\+Two}}
